  ...
  return (
    <footer id="waitlist" className="bg-cosmo-dark pt-40 pb-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Footer Area */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 py-20 border-t border-white/5">
          {/* Logo Column */}
          <div className="md:col-span-5">
            <div className="w-10 h-10 border border-white/20 glass rounded-xl flex items-center justify-center font-display font-black text-xs mb-6">
              [Logo]
            </div>
            <p className="text-white/30 text-xs font-black uppercase tracking-widest leading-loose">
              Cosmo 2026. <br />
              Made with love in Almaty.
            </p>
          </div>
          ...
          <div className="md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12">
            <div>
              <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 mb-6">Company</h4>
