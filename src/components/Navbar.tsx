...
export function Navbar() {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-8 py-5 border border-white/10 glass-heavy rounded-full flex items-center justify-between">
        ...
        <div>
          <button className="px-8 py-2.5 bg-white text-cosmo-dark text-[10px] font-black tracking-widest uppercase rounded-full hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)]">
            Join Waitlist
          </button>
        </div>
      </div>
